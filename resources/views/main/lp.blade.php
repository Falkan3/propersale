                    ...
                    <div class="container" style="padding-top: 0; mragin-bottom: 0;">
                        <div class="row" style="margin: 60px 0;">
                            ...
                            <div class="email_form no_margin">
                                ...
                                <form id="email_form" method="post" action="{{url('/mail')}}"
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <button type="submit" value="submit" class="center_mrg"><p
                                                            class="big-text medium"><span class="strong">Chcę zarabiać<br />więcej</span></p>
                                                </button>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 margin_on_mobile_big">
