...
@section('title', 'ProperSALE | Polityka cookies')
        ...
        <div class="container">
            ...
            <p><i class="icon fa fa-download margin_small"></i>Pobierz dokument:
                <i class="icon fa fa-file-pdf-o margin_small"></i><a
                        href="{{url('documents/polityka_cookies _propersale.pdf')}}" target="_blank">PDF</a>
            </p>

            <hr />

            <div>
                <p>Poniżej zamieszczamy najważniejsze informacje dotyczące plików cookie używanych w Serwisie
                ...
                <ol class="regulation_list">
                    ...
                    <li>
                        <h1>Do czego używamy plików Cookies?</h1>

                        <ol>
                            <li>
                                <p>Używamy ich by Strona ProperSale.pl stawała się łatwiejsza (bardziej intuicyjna) w
                                    użytkowaniu i aby lepiej dopasować nasze Strony oraz nasze produkty do
                            ...
                            <li>
                                <p>Używamy ich także do kompilacji anonimowych, statystyk, które pomagają nam zrozumieć
                                    jak ludzie używają naszych stron i pomagają w polepszeniu ich struktury i
                                    zawartości.</p>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <table>
                            <tr>
                                <th><p><span class="strong">Typ pliku Cookie</span></p></th>
                                <th><p><span class="strong">Co ono robi?</span></p></th>
                                <th><p>
                                        <span class="strong">Czy te pliki zbierają moje dane osobowe/identyfikują mnie?</span>
                                    </p></th>
                            </tr>
                            <tr>
                                ...
                                <td><p>Te pliki nie identyfikują Państwa personalnie. Jeżeli nie zaakceptują Państwo
                                        tych plików Cookie, może to wpłynąć na prawidłowe działanie strony lub jej
                                        części.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p>Te pliki Cookies pomagają nam zrozumieć jak odwiedzający wchodzą w interakcje z
                                        ...
                                        naszej strony. Do tego celu wykorzystujemy narzędzie monitorujące Google
                                        Analytics</p>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>Informacje, które te pliki zbierają mogą zawierać również te, które mogą Państwa
                                        identyfikować, a które sami Państwo udostępniacie, np. nazwę użytkownika. Zawsze
                                        będziemy z Państwem szczerzy na temat danych, które zbieramy, tego co z nimi
                                        robimy i z kim się nimi dzielimy. Jeżeli Państwo nie włączą tych plików, może to
                                        wpłynąć na działanie strony internetowej i jej funkcjonalności oraz może
                                        ograniczyć dostęp do jej zawartości.</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p>Informacje, które te pliki zbierają mogą zawierać również te, które mogą Państwa
                                        identyfikować, a które sami Państwo udostępniacie, np. nazwę użytkownika.</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p>Te pliki Cookies są używane do dostarczania Państwu zawartości odpowiednich dla
                                        ...
                                        ProperSale.pl i nie tylko. Możemy używać tych plików Cookie do zapamiętywania
                                        odwiedzanych przez Państwa stron i możemy dzielić się tą informacją z innymi
                                        stronami, wliczając w to reklamodawców i nasze agencje.
                                    </p>
                                </td>
                                <td>
                                    <p>Większość rodzajów tych plików namierza klientów za pomocą ich adresu IP, więc
                                        mogą być zbierane niektóre dane osobowe. W celu uzyskania bardziej szczegółowych
                                        informacji o tych plików, włączając to jakie dane są zbierane i w jaki sposób są
                                        używane prosimy o zapoznanie się z poniższymi akapitami.</p>
                                </td>
                            </tr>
                        </table>
                        ...
                        <p>W ramach Serwisu ProperSale.pl stosowane są dwa rodzaje plików cookies: "sesyjne" (session
                            ...
                            cookie lub do czasu ich usunięcia przez Użytkownika. Niektóre strony, które Państwo
                            odwiedzają mogą również zbierać informacje za pomocą pixel tags (zwanymi również clear
                            gifs), które mogą być również udostępnione stronom trzecim, które bezpośrednio wspierają
                            nasze akcje promocyjne oraz rozwój stron internetowych. Na przykład, informacja na temat
                            użytkowania strony internetowej przez odwiedzających Strony ProperSale.pl mogą być
                            udostępnione stronom trzecim, tj. agencjom reklamowym w celu lepszego pozycjonowania
                            internetowych bannerów reklamowych na naszych stronach internetowych. Ta informacja nie jest
                            identyfikowalna osobowo, jednakże może jednak być połączona z Państwa danymi osobowymi.
                        </p>
                    </li>
                    <li>
                        ...
                        <p>Poniżej zamieszczamy linki do instrukcji zarządzania plikami cookies dla najpopularniejszych
                            przeglądarek:</p>
                        <ul>
                            <li><a href="http://support.mozilla.org/pl/kb/ciasteczka" target="_blank">Firefox</a></li>
                            <li><a href="http://support2.microsoft.com/kb/278835/pl" target="_blank">Internet
                                    Explorer</a></li>
                            <li><a href="https://support.google.com/chrome/answer/95647?hl=pl&ref_topic=3421433"
                                   target="_blank">Opera</a></li>
                            <li><a href="http://help.opera.com/Windows/8.0/pl/cookies.html" target="_blank">Chrome</a>
                            </li>
                        </ul>
                    </li>
                    <li>
